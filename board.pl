...
assert_board_cells :-
    ...
    assert_cell(3, 1, ' 1 '), assert_cell(3, 2, '   '), assert_cell(3, 3, '   '), assert_cell(3, 4, '   '), assert_cell(3, 5, '   '), assert_cell(3, 6, '///'), assert_cell(3, 7, '_r_'), assert_cell(3, 8, '\\\\\\'), assert_cell(3, 9, '   '), assert_cell(3, 10, '   '), assert_cell(3, 11, '   '), assert_cell(3, 12, '   '), assert_cell(3, 13, ' 1 '),
    ...
    assert_cell(7, 1, ' 5 '), assert_cell(7, 2, '|||'), assert_cell(7, 3, '_r_'), assert_cell(7, 4, '   '), assert_cell(7, 5, '   '), assert_cell(7, 6, '   '), assert_cell(7, 7, '   '), assert_cell(7, 8, '   '), assert_cell(7, 9, '   '), assert_cell(7, 10, '   '), assert_cell(7, 11, '_r_'), assert_cell(7, 12, '|||'), assert_cell(7, 13, ' 5 '),
    ...
    assert_cell(11, 1, ' 9 '), assert_cell(11, 2, '   '), assert_cell(11, 3, '   '), assert_cell(11, 4, '   '), assert_cell(11, 5, '   '), assert_cell(11, 6, '\\\\\\'), assert_cell(11, 7, '_r_'), assert_cell(11, 8, '///'), assert_cell(11, 9, '   '), assert_cell(11, 10, '   '), assert_cell(11, 11, '   '), assert_cell(11, 12, '   '), assert_cell(11, 13, ' 9 '),
